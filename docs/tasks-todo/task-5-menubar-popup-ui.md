...
- [x] 코너 라운딩 (13px)
- [x] 트레이 아이콘 클릭 핸들러
- [ ] **패널 위치 지정 (`position_menubar_panel`)** ← P0 필수
...
- [Task 2: 사용자 설정 커맨드](task-2-user-settings-commands.md)
- [Task 3: 급여 계산 엔진](task-3-salary-calculator.md)
- [Task 4: 온보딩 UI](task-4-onboarding-ui.md)

## 다음 태스크

- [Task 6: 설정 화면 UI](task-6-settings-ui.md)
