...
This runs `cargo test export_bindings -- --ignored` which generates `src/lib/tauri-bindings.gen.ts`.
...
- Generated TypeScript (`src/lib/tauri-bindings.gen.ts`)
...
src/lib/
├── tauri-bindings.gen.ts  # Generated (DO NOT EDIT)
