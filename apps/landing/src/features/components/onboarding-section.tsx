...
export function OnboardingSection() {
  return (
    <RevealSection className="bg-bg-primary px-6 pt-[60px] pb-20 md:px-[68px] md:pt-[100px] md:pb-[160px] lg:px-[120px]">
      <div className="mx-auto flex flex-col items-center gap-10 md:gap-20">
        <RevealItem className="text-center">
          <p className="c1-400 md:t1-400 text-text-medium">Onboarding</p>
