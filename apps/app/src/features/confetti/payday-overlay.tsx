...
export function PaydayOverlay({
  ...
  return (
    ...
    >
      ...
      <div className="pointer-events-none absolute top-1/2 left-1/2 h-[340px] w-[336px] -translate-x-1/2 -translate-y-1/2 rounded-full bg-green-60 opacity-60 blur-[200px]" />
